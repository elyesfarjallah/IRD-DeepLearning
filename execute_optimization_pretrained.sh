...
nohup python main.py --model_keys vit_l_32 --dataset_path datasets/2023-12-28_18-12-43 --n_epochs 30 --wandb_config_path wandb_config.json --n_trials 20 --n_epochs_validation 1 --prefered_device cuda:1 --batch_size_options 2 4 8 16 32 64 --pretrained >vit_l_32.out &
